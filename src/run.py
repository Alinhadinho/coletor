...
# A remoção de muitas libs GTK e a inclusão das essenciais para Slim/OpenCV.
...
# 1. Executa 'python run.py' para fazer o setup (que agora não chama ft.app).
# 2. '&& uvicorn...': Inicia o servidor Uvicorn usando a porta dinâmica $PORT do Render.
